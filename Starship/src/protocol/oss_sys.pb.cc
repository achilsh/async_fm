...
void protobuf_AssignDesc_oss_5fsys_2eproto() {
  ...
  LogLevel_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(LogLevel, _unknown_fields_),
      -1,
      ::google::protobuf::DescriptorPool::generated_pool(),
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(LogLevel));
...
::google::protobuf::uint8* LogLevel::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
...
void LogLevel::MergeFrom(const ::google::protobuf::Message& from) {
  ...
  const LogLevel* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const LogLevel*>(
      &from);
  if (source == NULL) {
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
