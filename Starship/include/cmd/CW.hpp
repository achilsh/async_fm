...
enum E_CMD
{
    ...
    CMD_REQ_RELOAD_DOWN_STREAM          = 35,   ///< 重新加载down stream worker节点配置
    ...
    CMD_REQ_ALARM_SEDN_MON              = 41,   ///< 告警信息发送Monitor 子进程命令 
    ...
    CMD_REQ_RESTART_CHILDPROC           = 47,   ///< manager 通告worker 重启命令
    CMD_RSP_RESTART_CHILDPROC           = 48,   ///<  manager 通告worker 重启命令回应
