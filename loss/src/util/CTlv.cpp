...
CTlv::CTlv(unsigned int uiType, unsigned int uiLength, const loss::CBuffer& oBuff)
...
bool CTlv::Encode(unsigned int uiType, unsigned int uiInBuffLength, const loss::CBuffer& oInBuff, loss::CBuffer& oOutBuff)
{
...
bool CTlv::Encode(loss::CBuffer& oOutBuff)
{
    unsigned int uiWriteLength = 0;
...
bool CTlv::Decode(loss::CBuffer& oInBuff)
{
